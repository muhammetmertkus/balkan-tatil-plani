...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    code: "BYE-002 / PLAN",
    badge: "👑 PLAN A–Z",
    role: "Rota Amirali · Konaklama & B Planı Mimarı",
    title: "Balkan Prensesi & Baş Planlayıcı",
    quote: "“Ben planı yaptım; siz sadece bana uyun, saatinde arabada olun ve hayatta kalın.”",
    photo: assets.ikra,
    summary: "Airbnb, rota, alternatif planlar ve kimsenin sormadığı lojistik detayların doğal yöneticisi.",
    detail:
      "Grubun “hele bir gidelim de oraya varınca bakarız” gevşekliğine karşı kurulmuş canlı bir savunma bakanlığı. İkra tatile çıkmaz; lojistik haritası, saatlik zaman çizelgeleri ve park garantili konaklamalarıyla çok uluslu bir Balkan operasyonu yönetir. Üsküp–Ohrid–Sarandë–Himarë–Berat hattındaki her otelin check-in saatinden otoparkın eğimine kadar her detay onun masasından geçer. Planın dakik işlemesini şart koşarken prenses standartlarından ve konforundan asla taviz vermez.",
    duties: [
      "Her akşam ertesi günün park + check-in + rezervasyon üçlüsünü 5 dakikada denetlemek.",
      "“Burası merkeze uzak ama ucuz” diyenleri tek bakışla ve gerekçesiz veto etmek.",
      "Gruptaki erkeklerin “navigasyon yanlış gösteriyor buradan da kestirme var” teorilerini anında bastırmak.",
      "Günün ilk kahvesi ve akşam yemeği mekanlarının ambiyans ve temizlik standartlarını garantiye almak.",
    ],
    weakness: "Klimalı odanın sıcaklığı 23 derecenin üstüne çıktığında veya otoparkı olmayan otel önerildiğinde anlık sinir sistemi harareti.",
    secretWeapon: "4 farklı güneş gözlüğü, acil durum kombinleri ve her senaryoya hazır diplomatik prenses aurası.",
    tags: ["Planlama Bakanı", "Airbnb Dedektifi", "Fatih’in Karısı", "Sıfır Hata Toleransı", "VIP Balkan Prensesi"],
    focus: "Her akşam ertesi günün park + check-in + rezervasyon üçlüsünü 5 dakikada denetlemek.",
    tilt: "-2deg",
  },
  {
    id: "fatih",
    ...
    code: "BYE-003 / KASA",
    badge: "💶 IBAN / 4",
    role: "Bütçe · Splitwise · Döviz Arbitrajı",
    title: "CFO, IBAN Bakanı & Kasa",
    quote: "“Herkes 13.75 Euro atsın, 25 cent’i kimse için yuvarlamıyorum.”",
    photo: assets.fatih,
    summary: "Toplamı hesaplar, dörde böler ve IBAN’ı siz daha “ne kadar?” derken hazır eder.",
    detail:
      "Grubun para basma yetkisi hariç tüm yetkilere sahip bağımsız mali kuruluşu. Birileri daha “bu hesap ne kadar tuttu acaba?” diye ağzını açtığında, Fatih çoktan döviz kurunu çarpmış, dörde bölmüş ve Splitwise bildirimini göndermiştir. Kimin ne ödediği, kimin ne kadar borcu kaldığı, ortak kasadan kimin 1.5 Euro fazla su aldığı ve 37 TL’nin neden eksik olduğu gibi kritik devlet meseleleri onun yetki alanındadır. Arkadaşlık başka, tahsilat başkadır; gerektiğinde en yakın dostuna haciz memuru ciddiyetiyle yaklaşabilir.",
    duties: [
      "Her gece 22:30’da günün bütün fişlerinin fotoğrafını çekip EUR karşılığıyla Splitwise kaydını kapatmak.",
      "Kart çekmeyen Balkan esnafına karşı nakit Lek ve Denar stoğunu kontrollü piyasaya sürmek.",
      "“Burada bahşiş zorunlu mu?” tartışmalarını katı bir mali disiplinle karara bağlamak.",
      "Yakıt ve otopark masraflarını mililitre ve kuruş hassasiyetiyle kayda geçirmek.",
    ],
    weakness: "“Fatih sen öde sonra atarız kanka” cümlesi ve fişi kaybolan market alışverişleri.",
    secretWeapon: "Excel yüklü telefon, 4 farklı banka kartı, döviz dönüştürücü ve metal bozuk para kesesi.",
    tags: ["İnsan Hesap Makinesi", "Splitwise Terörü", "İkra’nın Kocası", "Tahsilat Servisi", "Nakit Yönetim Kurulu"],
    focus: "Her gece 22:30’da günün bütün fişlerinin fotoğrafını çekip EUR karşılığıyla Splitwise kaydını kapatmak.",
    tilt: "1.5deg",
  },
  {
    id: "eyup",
    ...
    code: "BYE-004 / UYUM",
    badge: "🚀 HER ŞEYE OK",
    role: "Araç · Konaklama Teyidi · Sahada Uyum Uzmanı",
    title: "Kültür Bakanı & Her Şeye OK",
    quote: "“Fark etmez kanka bana her türlü uyar, çıkalım görelim.”",
    photo: assets.eyup,
    summary: "Müze, beach, kale, gece dışarı: soru işareti varsa cevap zaten evettir.",
    detail:
      "Grubun adaptasyon katsayısı en yüksek, her ortama anında uyum sağlayan joker üyesi. Müze desen OK, beach desen OK, 40 derece sıcakta tarihî kale desen yine OK. Bir programa katılması için uzun açıklamalara gerek yoktur; planın sonunda soru işareti bulunması yeterlidir. Sabah Osmanlı dönemi köprülerini incelerken akşam kendisini sahil tavernasında bulabilecek kültürel esnekliğe ve bitmeyen bir yol enerjisine sahiptir.",
    duties: [
      "Kiralık araç tesliminde gövde çiziği, lastik durumu, kilometre ve depozito teyidini bizzat yapmak.",
      "Günlük yakıt seviyesini, Green Card sınır evraklarını ve sınır kapısı kuyruklarını takip etmek.",
      "Yerel halk ve sınır polisleriyle beden dili diplomasisini yürütüp gerginlikleri eritmek.",
      "Grubun keşif temposu düştüğünde “hadi kalkın şurayı da görelim” diyerek ekibi ayağa kaldırmak.",
    ],
    weakness: "“Bugün hiçbir yere gitmeyelim bütün gün otelde oturalım” teklifi.",
    secretWeapon: "Deri ceket, karizma siyah gül, sınırsız sahra enerjisi ve her şeye evet diyebilme cesareti.",
    tags: ["Kültür Bakanı", "Uyum Uzmanı", "Her Şeye OK", "Gelmişken Gidelim", "Sınır Diplomatı"],
    focus: "Kiralık araç tesliminde gövde çiziği, lastik durumu, kilometre ve depozito teyidini bizzat yapmak.",
    tilt: "-1deg",
  },
];
