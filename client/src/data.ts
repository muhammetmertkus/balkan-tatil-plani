...
export const teamMembers: TeamMember[] = [
  {
    ...
    detail:
      "Dışarıdan bakınca 'hallederiz ya' rahatlığında takılan ama sırt çantasında mini bir sahra hastanesi ve alet çantası taşıyan EDC (Everyday Carry) sevdalısı alçakgönüllü mühendis. Başınız ağrısa, mideniz yansa ya da bir alet gerekse saniyesinde çantasından doğru ilaç ve multitol çıkarır. Gündüzleri Üsküp ve Ohri'nin bit pazarlarında tozlu antika ve nostaljik eşya peşinde koşar; akşamları ise 'hadi kutu oyunu oynuyoruz' diyerek ekibi masaya kilitler. Ortamdaki en gergin krizi 3 saniyede absürt bir şakayla kahkahaya çevirebilir. Fakat gece yastığa başını koyduğunda “Ohrid’deki garsona teşekkür ederken ses tonum fazla mı sertti, gidip özür mü dilesem?”, “Acaba gizli gay miyim?” gibi dipsiz varoluşsal sorgulamalarla sabahı eder.",
    duties: [
      ...
      "Akşamları otele veya Airbnb'ye dönüldüğünde çantadan kutu oyunu çıkarıp ekibe kıran kırana turnuva yaptırmak.",
    ...
    weakness: "Gece sessizliğinde aniden başlayan overthinking atakları, bit pazarında harcanan saatler ve kutu oyununda hile yapılması.",
    secretWeapon: "EDC acil durum çantası (parol, mide hapı, multitol), seyahat boy kutu oyunu ve bitmeyen makara enerjisi.",
    tags: ["⭐ PROFESYONEL BEKÂR ⭐", "Yürüyen Eczane / EDC", "Bit Pazarı Kurdu", "Kutu Oyunu Koleksiyoneri", "Sözde Mühendis"],
    focus: "EDC lojistiği (ilaç/alet), bit pazarı keşfi, akşam kutu oyunu seansları ve aşırı düşünmek.",
    tilt: "2deg",
  },
  {
    id: "ikra",
  ...
  },
  {
    ...
    code: "BYE-003 / KASA",
    badge: "💶 MASTER CFO & KRİZ ÇÖZÜCÜ",
    role: "Bütçe Mimarı · Splitwise Şefi & Ekibin Güvenilir Kalesi",
    title: "CFO, Kriz Çözücü & Mantık Generali",
    quote: "“Bana bırakın hallederim; hem parayı kurtarırız hem işi çözeriz... Ama herkes 13.75 Euro atsın!”",
    photo: assets.fatih,
    summary: "Kriz anlarında soğukkanlı bir stratejist, parayı ve ekibi sırtlayan dahi CFO, tatlı troll bilirkişi.",
    detail:
      "Grubun mali güvencesi, kriz anlarındaki soğukkanlı stratejisti ve en güvenilir kalesi. Dışarıdan hafiften 'o öyle yapılmaz yalnız' bilirkişiliği ve tatlı trollükleriyle ortamı kışkırtıyor gibi görünse de, işler sarpa sardığında ilk devreye giren ve problemi tereyağından kıl çeker gibi çözen kişidir. Finansal zekası sayesinde ekibi Balkan kazıklarından korur, döviz kurunu ve pazarlığı ustalıkla yönetir. Hem İkra'nın en büyük hayat ortağı hem de grubun asla vazgeçilemez operasyonel ve finansal belkemiğidir.",
    duties: [
      "Kriz ve belirsizlik anlarında soğukkanlılığını koruyup en mantıklı çözüm yolunu üreterek ekibi rahatlatmak.",
      "Balkan esnafının kazık tarifelerine ve döviz oyunlarına karşı grubu kuruşu kuruşuna korumak.",
      "Her gece 22:30’da günün bütün harcamalarını adil, şeffaf ve kusursuz şekilde Splitwise’a girmek.",
      "Tatlı kışkırtmalar ve bilirkişi takılmalarıyla ekibin makarasını ve enerjisini canlı tutmak.",
      "Yol boyunca bütçe disiplinini, nakit yönetimini ve operasyonel düzeni sırtlamak.",
    ],
    weakness: "Fişi kaybolan market alışverişleri ve 'Fatih halleder' denilerek üzerine yığılan 47 farklı iş.",
    secretWeapon: "Üstün kriz çözme refleksi, Excel yüklü telefon, güven veren liderliği ve metal bozuk para kesesi.",
    tags: ["Master CFO", "Kriz Çözücü", "Mantık Kalesi", "İkra’nın Kocası", "Güvenilir Belkemiği"],
    focus: "Mali disiplini sağlamak, krizleri anında çözmek ve ekibin operasyonel güvencesi olmak.",
    tilt: "1.5deg",
  },
  {
    id: "eyup",
