...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    name: "Enis Aldemir",
    code: "BYE-005 / GÖNÜL",
    badge: "🌙 RESMÎ İSTANBUL BEKÇİSİ & MANGAL ORDİVARYÜSÜ 🥩",
    role: "İstanbul Bekçisi · Yaz Kış Montlu & Nişantaşı Gelinlik Mağduru",
    title: "İstanbul Nöbetçisi, Mangal Başı Üstadı & Eski Motorcu",
    quote: "“Kampa hayatta gelmem ama mangal varsa düşünürüz moruk... Bir de hava serin mi montumu alayım mı?”",
    photo: assets.enis,
    summary: "Yazın bile montla gezen mangal bağımlısı, parasızlıktan motorunu satıp Nişantaşı'nda gelinlik bakan çiçeği burnunda damat.",
    detail:
      "Dünyanın en masum ve temiz kalpli insanı; ekip Balkanlar'dayken İstanbul'un asayişini ve piyasalarını tek başına bekler. Tam bir mangal bağımlısıdır; köz ve et kokusu aldığı an gözleri parlar ama kampa veya çadıra hayatta adımını atmaz. Kronik olarak sürekli üşür; Ağustos sıcağında bile üzerinde mont veya mevsimlik ceketle gezmesiyle meşhurdur. Eskiden rüzgar gibi estiği bir motoru vardı fakat nakit darlığından istemeye istemeye sattı. Şimdilerde ise evlilik arifesinde olduğu için Nişantaşı butiklerinde gelinlik bakmaktan ve masraf yapmaktan Harem Altın'daki grafiklere içi yana yana bakar. Direksiyon hakimiyeti efsanedir, arabasına toz kondurmaz. Ortamda yabancı bir kız görünce hafiften çekinmesi, evde Recep İvedik açıp rahatına bakması ve saf esnaf samimiyetiyle ekibin gözbebeğidir.",
    duties: [
      "İstanbul'da mangal başı operasyonlarını yönetmek ve ekibin dönüşüne dev et ziyafeti hazırlamak.",
    ...
    weakness: "Klimanın 24 derecenin altına inmesi (anında mont giyer), Nişantaşı gelinlik fiyatları, motor ilanları ve kampa çağrılmak.",
    secretWeapon: "Yaz kış üzerinden çıkmayan montu, mangal maşası, Harem Altın canlı grafiği ve usta direksiyonu.",
    tags: ["🌙 RESMÎ İSTANBUL BEKÇİSİ", "Mangal Bağımlısı", "Yaz Kış Montlu", "Nişantaşı Damadı", "Eski Motorcu"],
    focus: "Mangal operasyonları, mont konforu, altın piyasası takibi ve evlilik bütçesi.",
    tilt: "1deg",
  },
];
