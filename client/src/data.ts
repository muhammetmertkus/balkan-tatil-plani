...
export const teamMembers: TeamMember[] = [
  {
    ...
    role: "Mühendis (Sözde) · Profesyonel Bekâr & Gece Filozofu",
    title: "Alçakgönüllü Makara Sorumlusu & Overthinking CEO",
    quote: "“Şimdi size çok mantıklı bir şey söyleyeceğim ama lütfen gülmeyin...”",
    photo: assets.mert,
    summary: "Ekipte herkes çift gezerken bekarlık nöbeti tutan, 38 sekme açık gezen alçakgönüllü mühendis.",
    detail:
      "Dışarıdan bakınca 'hallederiz ya bana ne' modunda gezen ama içeride işlemcisi 95 derecede çalışan, grubun alçakgönüllü mühendisi. Ortamdaki en gergin krizi 3 saniyede saçma sapan bir şakayla kahkahaya çevirebilir ya da durduk yere en basit olaydan komplo teorisi çıkarabilir. Fakat gece yastığa başını koyduğunda “Ohrid’deki garsona teşekkür ederken ses tonum fazla mı sertti, gidip özür mü dilesem?”, “Acaba gizli gay miyim?” gibi dipsiz varoluşsal sorgulamalarla sabahı eder. Kadronun tek bekârı olarak bağımsızlık ve makara bayrağını gururla taşır.",
    duties: [
      ...
      "Yol üstündeki en ucuz kahveciyi, f/p esnaf lokantalarını ve indirimleri koklayarak bulup bütçeyi kurtarmak.",
      "Mühendislik diplomasını sadece telefondan navigasyon açmak ve eSIM ayarı yapmak için kullanmak.",
      "Evli çiftlerin arasındaki gerginlikleri aniden alakasız ve absürt bir espriyle sabote edip herkesi güldürmek.",
      "Geceleri 47 farklı kurgusal senaryo üreterek ertesi günkü araç içi muhabbet malzemesini hazırlamak.",
    ],
    weakness: "Gece sessizliğinde aniden başlayan overthinking atakları, sabah kahvesinin gecikmesi ve 'sen ne zaman evleniyorsun' soruları.",
    secretWeapon: "Yapay zeka araçları, alçakgönüllü sırıtış, montaj yeteneği ve bitmek bilmeyen makara enerjisi.",
    tags: ["⭐ PROFESYONEL BEKÂR ⭐", "Sözde Mühendis", "Alçakgönüllü Makara", "Overthinking CEO", "38 Sekme Açık"],
    focus: "Aşırı düşünmek, yapay zeka montajı yapmak ve ekibin makara seviyesini zirvede tutmak.",
    tilt: "2deg",
  },
  {
    id: "ikra",
    name: "İkra Siren",
    code: "BYE-002 / PLAN",
    badge: "👑 ZAAATEN PRENSESİ",
    role: "Rota Amirali · 'Zaaaten' Tescilli Baş Planlayıcı",
    title: "Balkan Prensesi & 'Ben Demiştim Zaaaten' Şefi",
    quote: "“Ben size demiştim zaaaten... Beni dinlemediniz, şimdi çekin zaaaten!”",
    photo: assets.ikra,
    summary: "Airbnb, rota ve her cümlenin sonundaki 'zaaaten' ile ortamı hizaya sokan VIP Balkan Kraliçesi.",
    detail:
      "Grubun “hele bir gidelim bakarız” rahatlığına karşı kurulmuş demir yumruklu prenses rejimi. İkra tatile çıkmaz; her adımında 'zaaaten böyle olacağı belliydi', 'orası çok kalabalık zaaaten' aforizmalarıyla 4 kişiyi tek bakışıyla hizaya sokar. Üsküp–Ohrid–Sarandë–Himarë–Berat hattındaki her otelin klima derecesinden kahvaltı saatine kadar her detay onun onayından geçer. Erkeklerin 'kestirme yol' teorilerini tek bir 'zaaaten saçmalıyorsunuz' cümlesiyle tarihe gömer.",
    duties: [
      "Grup yanlış bir karar aldığında anında 'Ben size demiştim zaaaten' damgasını vurmak.",
      "Her akşam ertesi günün park + check-in + rezervasyon üçlüsünü 5 dakikada denetlemek.",
      "“Burası ucuz ama merkeze uzak” diyenleri tek bakışla ve 'zaaaten kalitesiz' diyerek veto etmek.",
      "Günün ilk kahvesi ve akşam yemeği mekanlarının ambiyans, hijyen ve prenses standartlarını garantiye almak.",
    ],
    weakness: "Klimalı odanın sıcaklığı 23 derecenin üstüne çıktığında veya planın 4 dakika gecikmesiyle gelen 'zaaaten' hararetleri.",
    secretWeapon: "4 farklı güneş gözlüğü, acil durum kombinleri ve lafı ağza tıkan 'zaaaten' tonlaması.",
    tags: ["👑 ZAAATEN PRENSESİ", "Planlama Bakanı", "Fatih’in Karısı", "Sıfır Hata Toleransı", "VIP Standartlar"],
    focus: "Her plana 'zaaaten' haklılığıyla liderlik etmek ve VIP standartları korumak.",
    tilt: "-2deg",
  },
  {
    id: "fatih",
    ...
    code: "BYE-003 / KASA",
    badge: "💶 TROLL CFO / BİLİRKİŞİ",
    role: "Bütçe · Splitwise · Baş Troll & Antipatik Bilirkişi",
    title: "CFO, Baş Kışkırtıcı & 'O Öyle Değil Yalnız' Şefi",
    quote: "“O öyle yapılmaz yalnız, ver bir de ben bakayım... Ayrıca herkes 13.75 Euro atsın!”",
    photo: assets.fatih,
    summary: "Her konudan anlayan bilirkişi trollüğü, sinir bozan itirazları ve 25 cent'i affetmeyen Splitwise terörü.",
    detail:
      "Grubun hem para basma yetkisine sahip maliye bakanı hem de en antipatik troll bilirkişisi. Ortamda gayet huzurlu bir sohbet dönerken aniden araya girip 'O öyle değil yalnız, mantıken yanlış biliyorsunuz' diyerek herkesin sinir uçlarıyla oynar. Kimsenin sormadığı sorulara 20 dakika mantık dersi verir, sonra da 'ben zaten dalga geçiyordum' diyerek ortamdan sıyrılır. Tabii bu sırada Splitwise'a 1.25 Euro fazla su içenleri kaydetmeyi ve 37 TL eksik atanları darlamayı asla ihmal etmez.",
    duties: [
      "Grupta herkes sakinken aniden bir iddia ortaya atıp ortamı trollükle alevlendirmek.",
      "Her gece 22:30’da günün bütün fişlerini EUR karşılığıyla kuruşu kuruşuna Splitwise’a girmek.",
      "“Bunu Türkiye'de daha iyi yapıyorlar” diyerek en lezzetli Balkan yemeğine bile antipatik kulp takmak.",
      "Kart çekmeyen esnafa karşı nakit Lek/Denar stoğunu yönetirken Mert ve Eyüpcan'ı darlamak.",
    ],
    weakness: "Birinin ondan daha mantıklı konuşması ve fişi kaybolan market alışverişleri.",
    secretWeapon: "Excel yüklü telefon, sinir bozucu kışkırtma gülüşü ve 'ben demiştim' arşivleri.",
    tags: ["Baş Troll", "Antipatik Bilirkişi", "Splitwise Terörü", "İkra’nın Kocası", "O Öyle Değil Yalnız"],
    focus: "Ortamı kışkırtıp eğlenirken bütçeyi kuruşu kuruşuna tahsil etmek.",
    tilt: "1.5deg",
  },
  {
    id: "eyup",
...
export const dayPlans: DayPlan[] = [
  {
    id: "G0",
    dayNumber: 0,
    date: "30 Ağustos – 6 Eylül 2026",
    city: "Tüm Balkan Döngüsü (1.180 km)",
    title: "İstanbul ✈️ Üsküp → Ohri → Sarandë → Ksamil → Himarë → Berat → Üsküp ✈️ İstanbul",
    sleep: "Üsküp (2 Gece) · Ohri (1 Gece) · Sarandë (2 Gece) · Himarë (1 Gece) · Berat (1 Gece)",
    drive: "Toplam ~1.180 km Karayolu Sürüşü + 2 Uçuş",
    walk: "Toplam ~68 km Antik Kent, Kale & Plaj Yürüyüşü",
    risk: "Qafë Thanë sınır kapısı pasaport kuyruğu & Llogara virajlı dağ geçidi",
    route: "İstanbul ✈️ SKP → A2 Otoyolu → Ohri → Qafë Thanë Sınırı → Gjirokastër → Blue Eye → Sarandë → Ksamil → Butrint → Borsh → Porto Palermo → Himarë → Llogara Geçidi → Berat → Elbasan → Üsküp → SKP ✈️ İstanbul",
    timing: [
      "G1: İstanbul ✈️ Üsküp iniş, araç teslimi ve Eski Çarşı / Bit Pazar keşfi",
      "G2: Üsküp → Straža Dağ Geçidi böreği → Ohri Samuel Kalesi & Kaneo gün batımı",
      "G3: Ohri → Qafë Thanë sınırı → Gjirokastër Kalesi → Blue Eye → Sarandë kordonu",
      "G4: Sarandë → Ksamil Adalar koyu & Butrint UNESCO antik kenti",
      "G5: Sarandë → Borsh Şelalesi → Porto Palermo Ali Paşa Kalesi → Himarë Spile",
      "G6: Himarë → Livadhi Koyu → Llogara Dağ Geçidi (1.043m) → Berat Mangalem",
      "G7: Berat Kalesi → Belsh Gölleri → Elbasan → Üsküp kapanış yemeği",
      "G8: Üsküp → SKP Havalimanı araç iadesi → İstanbul ✈️ Büyük Dönüş",
    ],
    ...
    eat: {
      summary: "8 gün boyunca kebap, tavče gravče, lagün midyesi, taze deniz mahsulleri ve geleneksel Balkan lezzetleri.",
  ...
  },
  {
    ...
    title: "Berat Kalesi Keşfi, Büyük Dönüş & Üsküp Kapanış Gecesi",
    sleep: "Üsküp · Aerodrom veya Merkez (Havalimanına hızlı çıkış)",
    drive: "313 km · 5 sa 40 dk saf sürüş (Mola + sınırla ~7-8 saat)",
    walk: "2,3 km · Sabah kale içi tarihi halkası",
    risk: "Uçuş sabahına risk bırakmamak için bu gece Üsküp'te uyunmak ZORUNDADIR! 10:30'da Berat'tan çıkılmalı.",
    ...
    timing: [
      ...
      "10:30: Berat'tan kesin hareket",
      "12:30–13:15: Yol üstü yakıt ve hafif öğle yemeği molası",
      "14:00–15:15: Arnavutluk-Makedonya sınır geçişi (Sınır kuyruğu payı)",
      "18:00–19:00: Üsküp'e varış, otele giriş ve rahatlama",
      "19:30–21:30: East Gate Mall'da son eksik alışverişi / Debar Maalo'da veda sofrası",
      "22:00–23:00: Fatih'in büyük Splitwise mahkemesi ve kapanış hesaplaşması",
    ],
    car: "Dönüş yolu uzun ve sınırlıdır. Depoyu sınır öncesi makul seviyede tutun; Üsküp'e varınca ertesi günkü havalimanı teslimi için yakıt politikasını hatırlayın.",
    foot: "Berat Kalesi içi taşlıktır, sabah serinliğinde 1.5 saatlik gezi yeterlidir. Üsküp'te akşam sadece AVM veya hafif yürüyüş vardır.",
    eat: {
      summary: "Dönüş günü pratik börek/pide; Üsküp'te veda akşamında güzel bir et veya İtalyan sofrası.",
      places: "Gostivar börekçileri (öğlen) / Kaj Serdarot veya Distrikt (Üsküp akşamı)",
      mustTry: ["Gostivar Kıymalı Böreği", "Makedon Tava Ciğeri", "Kaymaklı Kırmızı Biber", "Makedon Rakısı (Son kadeh)"],
      tips: "Son geceyi valizleri düzenleyip dinlenerek geçirin; 6 Eylül sabahı uykulu araç kullanmayın.",
    },
    shop: {
      summary: "East Gate Mall son dakika hediyelik, market ve gümrüksüz ihtiyaçlar.",
      target: "East Gate Mall (Belasitsa 2, Üsküp)",
      tips: "Balkan çikolataları, ajvar kavanozları ve hediyelik peynirleri süpermarketten uygun fiyata kapatın.",
    },
    highlights: ["Berat Kalesi", "Onufri Müzesi", "East Gate Mall", "Üsküp Kapanış Sofrası"],
    points: ["berat_mangalem", "skopje_eastgate", "skopje_bazaar"],
  },
  {
    id: "G8",
    dayNumber: 8,
...
export const tenRules = [
  ...
  },
  {
    ...
    desc: "1 Eylül (Ohri → Sarandë) ve 5 Eylül (Berat → Üsküp) etapları sınır ve virajlarla 8–10 saattir. Sabah en geç 06:45–07:00'de kontak çevrilir.",
  },
  {
    id: 4,
