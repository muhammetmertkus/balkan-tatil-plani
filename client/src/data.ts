...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    name: "Enis Aldemir",
    code: "BYE-005 / GÖNÜL",
    badge: "🌙 RESMÎ İSTANBUL BEKÇİSİ & MANGAL MAKARA ŞEFİ 🥩",
    role: "İstanbul Bekçisi · Yaz Kış Montlu & Nişantaşı Gelinlik Mağduru",
    title: "İstanbul Nöbetçisi, Sıfır İş Yapan Mangal Gurmesi & Eski Motorcu",
    quote: "“Közü siz yelleyin ben et pişince haber veririm moruk... Bir de hava serin mi montumu alayım mı?”",
    photo: assets.enis,
