...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    name: "Enis Aldemir",
    code: "BYE-005 / GÖNÜL",
    badge: "🌙 RESMÎ İSTANBUL BEKÇİSİ & HAREM ALTIN ORDİVARYÜSÜ 📱",
    role: "İstanbul Bekçisi · Eski Telefoncu / Yeni Kuyumcu & Mert’ten Gizli Sigara Şefi",
    title: "Resmî İstanbul Bekçisi, Usta Direksiyon & 'Kankiii' Başkomutanı",
    quote: "“Kankiii voleybola gelemem hatun izin vermedi... Harem Altın'da gram 3.200 oldu bu arada!”",
    photo: assets.enis,
    summary: "Ekip Balkanlar'dayken şehri tek başına tutan Resmî İstanbul Bekçisi, Harem Altın bağımlısı ve saf kalpli Recep İvedik gurmesi.",
    detail:
      "Dünyanın en masum, saf ve tertemiz kalpli insanı; fakat bu turda fiziksel olarak aramızda olmasa bile 'Resmî İstanbul Bekçisi' olarak şehrin nöbetini tek başına tutuyor. Günün 18 saati telefonunda açık duran Harem Altın uygulamasında ons ve çeyrek altın grafiği takip eder; esnaflıktan kalma refleksle yoldan geçen teyzeye bile 'Kankiii' diye seslenebilir. Eski bir amatör futbolcudur fakat şu an topla ilişkisi 'Recep İvedik’in kuru fasulye maçı' seviyesindedir. Ancak direksiyon başına geçtiğinde tek elle tır park edecek kadar usta bir şofördür. En büyük fobisi ise ortama tanımadığı yabancı bir kız girdiğinde panik atak geçirip sessizce arkaya saklanmasıdır. Gizli zevkleri: Mert'in radarından köşe bucak kaçarak kuytuda sigara tellendirmek, geğirip osurarak hayatın stresini atmak ve baştan sona Recep İvedik maratonu yapmaktır.",
    duties: [
      "Ekip Balkanlar'dayken İstanbul'un asayişini ve kuyumcu piyasasını tek başına beklemek.",
      "Balkanlar'daki ekibe 10 dakikada bir Harem Altın'dan altın/euro arbitraj raporu geçmek.",
      "Mert arkasını döndüğü anda saniyede 3 fırt çekip izmariti yok etme operasyonunu icra etmek.",
      "Grup WhatsApp'ına en az 3 kez 'Kankiii' içeren arabalı ses kayıtları fırlatmak.",
      "Ortamda tanımadığı yabancı bir kız belirdiği anda 'bir lavaboya gidip geliyorum' diyerek sıvışmak.",
      "İstanbul'da tek başına kalınca son ses Recep İvedik açıp tam tekmil esnaf rahatlığına geçmek.",
    ],
    weakness: "Ortamda aniden beliren tanımadığı bir kız, altının 20 TL düşmesi, Mert'in sigara kokusu alması ve düğünlerde horon oynamak.",
    secretWeapon: "Harem Altın canlı grafiği, İstanbul bekçi düdüğü, usta şoförlük refleksi ve sınırsız 'Kankiii' enerjisi.",
    tags: ["🌙 RESMÎ İSTANBUL BEKÇİSİ", "Harem Altın Ordivaryüsü", "Mertten Gizli Sigaracı", "Kankiii Başkomutanı", "Recep İvedik Gurmesi"],
    focus: "İstanbul asayişi & nöbeti, canlı altın takibi, Mert'ten sigara saklama ve sınırsız 'Kankiii' dostluğu.",
    tilt: "1deg",
  },
];
