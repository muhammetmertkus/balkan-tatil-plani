...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    name: "Enis Aldemir",
    code: "BYE-005 / GÖNÜL",
    badge: "📱 HAREM ALTIN ORDİVARYÜSÜ & ONURSAL FİRARİ",
    role: "Eski Telefoncu · Yeni Kuyumcu & Mert’ten Gizli Sigara Şefi",
    title: "Kapalıçarşı Masası Başkanı, Usta Direksiyon & 'Kankiii' Başkomutanı",
    quote: "“Kankiii voleybola gelemem hatun izin vermedi... Harem Altın'da gram 3.200 oldu bu arada!”",
    photo: assets.enis,
    summary: "Ortamda tanımadığı kız görünce sistemi kilitlenen, Mert'e sigara yakalanma stresi yaşayan, saf kalpli Recep İvedik gurmesi.",
    detail:
      "Dünyanın en masum, saf ve tertemiz kalpli insanı; fakat bu turda fiziksel olarak aramızda olmasa bile manevi ağırlığıyla her virajda bizimle. Günün 18 saati telefonunda açık duran Harem Altın uygulamasında ons ve çeyrek altın grafiği takip eder; esnaflıktan kalma refleksle yoldan geçen teyzeye bile 'Kankiii' diye seslenebilir. Eski bir amatör futbolcudur fakat şu an topla ilişkisi 'Recep İvedik’in kuru fasulye maçı' seviyesindedir. Ancak direksiyon başına geçtiğinde tek elle tır park edecek kadar usta bir şofördür. En büyük fobisi ise ortama tanımadığı yabancı bir kız girdiğinde panik atak geçirip sessizce arkaya saklanmasıdır. Gizli zevkleri: Mert'in radarından köşe bucak kaçarak kuytuda sigara tellendirmek, geğirip osurarak hayatın stresini atmak ve baştan sona Recep İvedik maratonu yapmaktır.",
    duties: [
    ...
    secretWeapon: "Harem Altın canlı grafiği, usta şoförlük refleksi, gizli zula çakmak ve sınırsız 'Kankiii' enerjisi.",
    tags: ["Harem Altın Ordivaryüsü", "Mertten Gizli Sigaracı", "Kankiii Genel Sekreteri", "Recep İvedik Gurmesi", "Usta Şoför"],
    focus: "Canlı altın kuru takibi, Mert'ten sigara saklama sanatı, Recep İvedik maratonu ve sınırsız 'Kankiii' dostluğu.",
    tilt: "1deg",
  },
];
